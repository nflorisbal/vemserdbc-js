...
const validarData = (event) => {
    ...
    let ehEntreDatas = data.isBetween(moment().subtract(18, 'years'), moment().subtract(26, 'years'));
    

    // console.log('é valida ' + ehDataValida);
    // console.log('é futura ' + ehDataFutura);
    console.log('é entre datas ' + ehEntreDatas);
